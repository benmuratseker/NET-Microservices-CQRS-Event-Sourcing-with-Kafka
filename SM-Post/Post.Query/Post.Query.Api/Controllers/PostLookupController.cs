...
namespace Post.Query.Api.Controllers
{
    ...
    public class PostLookupController : ControllerBase
    {
        ...
        public async Task<ActionResult> GetPostWithCommentsAsync()
        {
            ...
            {
                const string SAFE_ERROR_MESSAGE = "Error while processing request to find post by comments!";
                return ErrorResponse(ex, SAFE_ERROR_MESSAGE);
            }
        ...
        public async Task<ActionResult> GetPostWithNumberOfLikesAsync(int numberOfLikes)
        {
            try
            {
